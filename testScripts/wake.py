...
model = Model(
    wakeword_models=["C:\Users\justi\PycharmProjects\Kokoro\.venv\Lib\site-packages\openwakeword\resources\models\alexa_v0.1.tflite"],  # can also leave this argument empty to load all of the included pre-trained models
)
